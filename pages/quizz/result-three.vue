...
const addRemoveChosenKeyword = (keyword) => {
    if (store.naturekeywords.includes(keyword)) {
        store.naturekeywords = store.naturekeywords.filter(k => k !== keyword)
    } else {
        store.naturekeywords.push(keyword)
    }
}
            ...
            <div class="flex flex-row flex-wrap">
                <div    v-for="keyw of currentkeywords"
                    ...
                    <div 
                        ...
                        :class="{'border-primary': store.naturekeywords.includes(keyw)}"
